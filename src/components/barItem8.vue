...
import bar2 from './bar-8.vue';
import bar1 from './bar-9.vue';
...
<template>
  <div class="container">
    ...
    <!-- 仪表盘 -->
    <div class="btn-line">
      <el-button size="small" class="bar-btn" @click="itemData.showItem=1">区间时段</el-button>
      <el-button size="small" class="bar-btn" @click="itemData.showItem=2">VS曲线</el-button>
    </div>
    <!-- 柱形图 -->
    <bar-1 v-if="itemData.showItem===1"></bar-1>
    <bar-2 v-if="itemData.showItem===2"></bar-2>
