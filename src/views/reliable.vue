...
import reliableBar from '../components/reliable-bar.vue';
    ...
    <div class="content-box">
      ...
      <div class="card-container">
        <div class="left-box">
          ...
          <div class="card-box">
            <bar-item-slot title="5分钟及以上延误事件次数">
              <reliable-bar></reliable-bar>
            </bar-item-slot>
          </div>
        </div>
        ...
        <div class="right-box">
          <div class="card-box">
            <bar-item-slot title="最大延误时间">
              <reliable-bar></reliable-bar>
            </bar-item-slot>
          </div>
          <div class="card-box">
            <bar-item-slot title="5分钟及以上延误列车数">
              <reliable-bar></reliable-bar>
            </bar-item-slot>
          </div>
        </div>
