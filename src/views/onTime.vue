...
import onTimeBar from '../components/onTime-bar.vue';
import onTimeBar2 from '../components/onTime-bar-2.vue';
import onTimeBar3 from '../components/onTime-bar-3.vue';
import {
  postLineSectionData,
    ...
    <div class="content-box">
      ...
      <div class="card-container">
        <div class="left-box">
          ...
          <div class="card-box">
            <bar-item-slot title="1号线列车晚点列数占比">
              <div class="btn-line">
                <el-button size="small" class="bar-btn">列车晚点列数</el-button>
                <el-button size="small" class="bar-btn"
                  >列车晚点列数占比</el-button
                >
              </div>
              <on-time-bar></on-time-bar>
            </bar-item-slot>
          </div>
        </div>
        ...
        <div class="right-box">
          <div class="card-box">
            <bar-item-slot title="列车晚点情况">
              <on-time-bar-3></on-time-bar-3>
            </bar-item-slot>
          </div>
          <div class="card-box">
            <bar-item-slot title="1号线列车运行时间偏差">
              <on-time-bar-2></on-time-bar-2>
            </bar-item-slot>
          </div>
        </div>
      </div>
